...
function Convert () 
{
		...
		ffmpeg -i "$FILENAME" -c:v libx264 -profile:v high -level 4.1 -b:v 1500k -maxrate 2500k -bufsize 5000k -threads 0 -codec:a aac -b:a 128k -filter:a "volume=1.5" "$OUTPUTDIR/Converted/$NEWNAME"
		wait	
}	# end function
