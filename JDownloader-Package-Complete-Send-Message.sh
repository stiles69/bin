...
/*
    Event Script: sendMessageDownloadCompleted
 
                  Sends a message to Pushover that download is completed.
 ...
 */
 ...
 //---------- Global declarations -----------------
var bSendMessage = false; //pessimistic approach: no file-writing at start, if situation ok, then set it "true"
var sSendMessageScriptFilePath = "/home/brettsalemink/lib/node/jdownloader-completed/index.js"; // the path of the send message script
